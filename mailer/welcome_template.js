const welcome = () => {
    ...
    <head>
      ...
      <style type="text/css" id="no-inline-css">
        @media screen and (max-width:9999px){
            ...
            .twitter img,.facebook img, .linkedin img {display:none !important;}
    ...
    <!--[if !((gte mso 9)|(IE))]>
      ...
      <body bgcolor="#FFFFFF" style="font-family:'Aktiv Grotesk', BlinkMacSystemFont, Helvetica, Arial, sans-serif; color:#090b0a"><span class="preheader" summary="preheader" style="display:none !important; Margin-left:-9999 !important; width:0 !important; height:0 !important; visibility:hidden !important; min-width:0 !important; min-height:0 !important; font-size:0 !important; line-height:0 !important"
              ...
              <!--[if mso]>
                <table cellpadding="0" cellspacing="0" border="0" style="padding:0px;margin:0px;width:100%;">
                  <tr>
                        ...
                        <tr>
                          <td class="center header-td" align="center" valign="middle" width="33.33%">
                            ...
                            data-hs-link-id="0" target="_blank">
                              <img src="https://res.cloudinary.com/reyes181/image/upload/v1597185021/taco/mstile-144x144.png"
                        ...
                        <tr>
                          <td>
                            ...
                            width="93.75%">
                              <tbody>
                                <tr>
                                  <td class="hello" align="center" style="font-family:'Aktiv Grotesk', BlinkMacSystemFont, Helvetica, Arial, sans-serif; font-weight:bold; font-size:10px; color:#424659; letter-spacing:1px; text-transform:uppercase; border:30px solid #ffffff">Hello!</td>
                                </tr>
                                <tr>
                                  <td align="center">
                                    <h1 style="font-family:'Aktiv Grotesk', BlinkMacSystemFont, Helvetica, Arial, sans-serif; font-weight:bold; margin:0 auto; font-size:40px; color:#111111; letter-spacing:-0.5px; line-height:48px">You're in!</h1>
                                  </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                  <td align="center">
                                    <p class="hero-p" style="font-family:'Aktiv Grotesk', BlinkMacSystemFont, Helvetica, Arial, sans-serif; font-weight:normal; font-size:16px; margin:0 auto; letter-spacing:0; line-height:32px; color:#a0a0a0; margin-top:20px; margin-bottom:30px; width:75%; max-width:450px; Margin:0 auto"
                                    width="75%">We are glad you signed up to be part of the TacoShop community. The door has been
                                          open for amazing deals on our accessories and apperals.
                                      <br>
                                      <br>In the meantime, here are a few parts of TacoShop you might have missed:</p>
                                  </td>
                                </tr>
                              </tbody>
                            </table>
                    ...
                    <table class="alt-table border-gap" align="center" valign="top" cellpadding="0"
                    cellspacing="0" style="border:15px solid #ffffff; width:84.375%; max-width:570px; Margin:0 auto"
                    width="84.375%">
                      <tbody>
                        <tr>
                          <td height="50" style="height:50px;font-size:0;line-height:0;border-right:1px solid #CCCCCC;">&nbsp;</td>
                          <td style="height:50px;font-size:0;line-height:0;">&nbsp;</td>
                        </tr>
                      </tbody>
                    </table>
                    <table class="card-outer-table border-gap" align="center" valign="top" cellpadding="0"
                    cellspacing="0" style="border:15px solid #ffffff; width:100%; max-width:768px; Margin:0 auto"
                    width="100%">
                      <tbody>
                        <tr>
                        ...
                        <tr>
                          <td>
                            <table class="card-inner-table" align="center" valign="top" border="0" cellpadding="0"
                            cellspacing="0" style="width:100%;max-width:738px;Margin:0 auto;">
                              <tbody>
                                <tr>
                                  <td>
                                    <a href="/"
                                    target="_blank" data-hs-link-id="0">
                                      <img src="https://res.cloudinary.com/reyes181/image/upload/v1597183194/taco/email_c.png"
                                      width="738" style="width:100%;max-width:738px;display:block;">
                                    </a>
                                  </td>
                                </tr>
                              </tbody>
                        ...
                        <tr>
                          <td>
                            <table class="inner-table card-text" summary="inner-table" align="center" valign="top"
                            border="0" cellpadding="0" cellspacing="0" style="width:93.75%; max-width:630px; Margin:0 auto"
                            width="93.75%">
                              <tbody>
                                <tr>
                                  <td align="center">
                                    <h1 style="font-family:'Aktiv Grotesk', BlinkMacSystemFont, Helvetica, Arial, sans-serif; font-weight:bold; margin:0 auto; font-size:24px; color:#65648c; letter-spacing:0; line-height:32px; margin-top:23px; display:none">Summer Styles</h1>
                                  </td>
                                </tr>
                                <tr>
                                  <td align="center">
                                    <p style="font-family:'Aktiv Grotesk', BlinkMacSystemFont, Helvetica, Arial, sans-serif; font-weight:normal; font-size:16px; margin:0 auto; letter-spacing:0; line-height:32px; max-width:380px; margin-bottom:30px">
                                      New collection of summer items have been added for your summer vibes.</p>
                                  </td>
                                </tr>
                                <tr>
                                  <td align="center">
                                    <div>
                                      <!--[if mso]>
                                        ...
                                        href="https://www.designbetter.co/podcast" style="height:60px;v-text-anchor:middle;width:300px;"
                                        arcsize="50%" stroke="f" fillcolor="#65648c">
                                          <w:anchorlock/>
                                          <center>
                                          <![endif]-->
                                          <a href="https://tacoshop-er.herokuapp.com/"
                                          style="background-color:#65648c !important;color:#FFFFFF !important;border-radius:35px;display: inline-block !important;"
                                          data-hs-link-id="4" target="_blank">
  <span class="card-cta" summary="card-cta" style="border-radius:35px;border:1px solid #65648c;background-color:#FFFFFF;padding:10px 44px 10px 44px;color:#65648c;display:inline-block;font-family: 'Aktiv Grotesk', BlinkMacSystemFont, Helvetica,Arial,sans-serif;font-weight: bold;font-size:10px;letter-spacing:1px;line-height:20px !important;text-transform:uppercase;text-align:center;text-decoration:none;-webkit-text-size-adjust:none;">BROWSE ITEMS</span>
                              ...
                              <tbody>
                                <tr>
                                  <td>
                                    <a href="/"
                                    target="_blank" data-hs-link-id="0">
                                      <img src="https://res.cloudinary.com/reyes181/image/upload/v1597183194/taco/email_a.png"
                                      width="738" style="width:100%;max-width:738px;display:block;">
                                    </a>
                                  </td>
                                </tr>
                          ...
                          <td>
                            ...
                            width="93.75%">
                              <tbody>
                                <tr>
                                  <td align="center">
                                    <h1 style="font-family:'Aktiv Grotesk', BlinkMacSystemFont, Helvetica, Arial, sans-serif; font-weight:bold; margin:0 auto; font-size:24px; color:#65648c; letter-spacing:0; line-height:32px; margin-top:23px; display:none">Free Shipping</h1>
                                  </td>
                                </tr>
                                <tr>
                                  <td align="center">
                                    <p style="font-family:'Aktiv Grotesk', BlinkMacSystemFont, Helvetica, Arial, sans-serif; font-weight:normal; font-size:16px; margin:0 auto; letter-spacing:0; line-height:32px; max-width:380px; margin-bottom:30px">Free domestic shipping on all orders
                                     over $50. </p>
                                  </td>
                                </tr>
                                <tr>
                                  <td align="center">
                                    <div>
                                      <!--[if mso]>
                                        <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word"
                                        href="https://www.designbetter.co/workshops" style="height:60px;v-text-anchor:middle;width:300px;"
                                        arcsize="50%" stroke="f" fillcolor="#65648c">
                                          <w:anchorlock/>
                                          <center>
                                          <![endif]-->
                                          ...
                                          style="background-color:#65648c !important;color:#FFFFFF !important;border-radius:35px;display: inline-block !important;"
                                          data-hs-link-id="4" target="_blank">
  <span class="card-cta" summary="card-cta" style="border-radius:35px;border:1px solid #65648c;background-color:#FFFFFF;padding:10px 44px 10px 44px;color:#65648c;display:inline-block;font-family: 'Aktiv Grotesk', BlinkMacSystemFont, Helvetica,Arial,sans-serif;font-weight: bold;font-size:10px;letter-spacing:1px;line-height:20px !important;text-transform:uppercase;text-align:center;text-decoration:none;-webkit-text-size-adjust:none;">SHOP</span>
                              ...
                              <tbody>
                                <tr>
                                  <td>
                                    <a href="/"
                                    target="_blank" data-hs-link-id="0">
                                      <img src="https://res.cloudinary.com/reyes181/image/upload/v1597183192/taco/email_b.png"
                                      width="738" style="width:100%;max-width:738px;display:block;">
                                    </a>
                                  </td>
                                </tr>
                          ...
                          <td>
                            ...
                            width="93.75%">
                              <tbody>
                                <tr>
                                  <td align="center">
                                    <h1 style="font-family:'Aktiv Grotesk', BlinkMacSystemFont, Helvetica, Arial, sans-serif; font-weight:bold; margin:0 auto; font-size:24px; color:#65648c; letter-spacing:0; line-height:32px; margin-top:23px; display:none">Spice Your Life.</h1>
                                  </td>
                                </tr>
                                <tr>
                                  <td align="center">
                                    <p style="font-family:'Aktiv Grotesk', BlinkMacSystemFont, Helvetica, Arial, sans-serif; font-weight:normal; font-size:16px; margin:0 auto; letter-spacing:0; line-height:32px; max-width:380px; margin-bottom:30px">Add a little spice to you life with our range of clothing
                                     and accessories for your taco need.</p>
                                  </td>
                                </tr>
                                <tr>
                                  <td align="center">
                                    <div>
                                      <!--[if mso]>
                                        <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word"
                                        href="https://www.designbetter.co/design-leadership-handbook" style="height:60px;v-text-anchor:middle;width:300px;"
                                        arcsize="50%" stroke="f" fillcolor="#65648c">
                                          <w:anchorlock/>
                                          <center>
                                          <![endif]-->
                                          ...
                                          style="background-color:#65648c !important;color:#FFFFFF !important;border-radius:35px;display: inline-block !important;"
                                          data-hs-link-id="4" target="_blank">
  <span class="card-cta" summary="card-cta" style="border-radius:35px;border:1px solid #65648c;background-color:#FFFFFF;padding:10px 44px 10px 44px;color:#65648c;display:inline-block;font-family: 'Aktiv Grotesk', BlinkMacSystemFont, Helvetica,Arial,sans-serif;font-weight: bold;font-size:10px;letter-spacing:1px;line-height:20px !important;text-transform:uppercase;text-align:center;text-decoration:none;-webkit-text-size-adjust:none;">VISIT SITE</span>
                    ...
                    <table class="inner-table" align="center" valign="top" cellpadding="0" cellspacing="0"
                    style="width:93.75%; max-width:630px; Margin:0 auto; border-top:45px solid #ffffff; border-bottom:45px solid #ffffff; border-left:15px solid #ffffff; border-right:15px solid #ffffff"
                    width="93.75%">
                      <tbody>
                        <tr>
                          <td height="1" width="100%" bgcolor="#CCCCCC" style="height:1px;font-size:0;line-height:0;background:#CCCCCC;">&nbsp;</td>
                        </tr>
                      </tbody>
                    </table>
                    <table class="alt-table border-gap p-n-cta" align="center" valign="top" cellpadding="0"
                    cellspacing="0" style="border:15px solid #ffffff; width:84.375%; max-width:570px; Margin:0 auto"
                    width="84.375%">
                      <tbody>
                        <tr>
                        ...
                        <tr>
                          <td align="center">
                            <p style="margin-bottom: 1em; font-family:'Aktiv Grotesk', BlinkMacSystemFont, Helvetica, Arial, sans-serif; font-weight:normal; font-size:16px; margin:0 auto; letter-spacing:0; line-height:32px">We hope you enjoy getting the first taste, and look forward to sharing more exclusive
                              deals, and of course free shipping!</p>
                          </td>
                        </tr>
                      </tbody>
                    </table>
                    <table class="inner-table border-gap author-table" align="center" valign="top"
                    ...
                    width="93.75%">
                      <tbody>
                        ...
                        <tr>
                          <td align="center" style="border:px solid #ffffff;"><span style="font-family:'Aktiv Grotesk', BlinkMacSystemFont, Helvetica, Arial, sans-serif; font-weight:bold; font-size:10px; letter-spacing:1px; text-transform:uppercase">All the best,</span>
                          </td>
                        </tr>
                        <tr>
                          <td height="45" style="height:45px;font-size:0;line-height:0;">&nbsp;</td>
                        ...
                        <tr>
                          <td align="center">
                            <img src="https://res.cloudinary.com/reyes181/image/upload/v1597185021/taco/mstile-144x144.png"
                            width="60" style="width:100%;max-width:60px;display:block;border-radius:30px;">
                          </td>
                        </tr>
                        <tr>
                          <td height="15" style="height:15px;font-size:0;line-height:0;">&nbsp;</td>
                        </tr>
                    ...
                    width="93.75%">
                      ...
                      <a href="/" style="font-family:'Aktiv Grotesk', BlinkMacSystemFont, Helvetica, Arial, sans-serif; font-weight:bold; font-size:10px; letter-spacing:1px; line-height:30px; color:#666666; text-decoration:none; text-transform:uppercase" data-hs-link-id="0" target="_blank">FOLLOW @TACOBELL</a>
                      <span class="gap" style="font-family:'Aktiv Grotesk', BlinkMacSystemFont, Helvetica, Arial, sans-serif; font-weight:bold; font-size:10px; letter-spacing:1px; line-height:30px; color:#666666; text-decoration:none; text-transform:uppercase"><span class="extra-spacing" style="font-family:'Aktiv Grotesk', BlinkMacSystemFont, Helvetica, Arial, sans-serif; font-weight:bold; font-size:10px; letter-spacing:1px; line-height:30px; color:#666666; text-decoration:none; text-transform:uppercase">&nbsp; </span>&nbsp;
                            ...
                            <a
                            href="https://www.tacobelltacoshop.com/"
                            ...
                            data-hs-link-id="1" target="_blank">VISIT OFFICAL TACOBELL.COM</a>
                              ...
                              class="row bottom-row" style="font-family:'Aktiv Grotesk', BlinkMacSystemFont, Helvetica, Arial, sans-serif; font-weight:bold; font-size:10px; letter-spacing:1px; line-height:30px; color:#666666; text-decoration:none; text-transform:uppercase">
                                <a href="https://portfolio-emilioreyes19.web.app/"
                                style="font-family:'Aktiv Grotesk', BlinkMacSystemFont, Helvetica, Arial, sans-serif; font-weight:bold; font-size:10px; letter-spacing:1px; line-height:30px; color:#666666; text-decoration:none; text-transform:uppercase"
                        ...
                        <tr>
                          <td align="center"> <span style="font-family:'Aktiv Grotesk', BlinkMacSystemFont, Helvetica, Arial, sans-serif; font-weight:bold; font-size:10px; letter-spacing:1px; line-height:30px; color:#666666; text-decoration:none; text-transform:uppercase">COPYRIGHT © 2020 TACO BELL TACO SHOP</span>
